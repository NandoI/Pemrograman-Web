...
<h5 align='center'> driver </h5>
    <div class='navbar'align="center">
        <table>
            ...
            include ('conn.php');
            $no=1;
            $query = mysqli_query($conn,"SELECT trans_upn.jumlah_km, driver.id_driver, driver.nama, driver.no_sim, driver.alamat FROM trans_upn JOIN driver ON id_trans_upn = driver.id_driver");
