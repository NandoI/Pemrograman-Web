...
class CDMusic extends product{
    ...
    public function displayCDMusic() {
        echo "Album dari artis " . $this->artist . " yang berjudul " . $this->getName() . " dengan genre " . $this->genre . " dibandrol dengan harga Rp. " . $this->getPrice() . " dengan discount 5% menjadi Rp. " . $this->getDiscount();
    }
}
